...
/**
 * This is the model class for table "tghstate".
 *
 * The followings are the available columns in table 'tghstate':
...
class State extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('state_name', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('state_id, country_id, state_name, create_dt, create_by, update_dt, update_by', 'safe', 'on'=>'search'),
		);
	}
