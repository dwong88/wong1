...
/**
 * This is the model class for table "tghpropertytype".
 *
 * The followings are the available columns in table 'tghpropertytype':
...
class Propertytype extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('property_type_name', 'length', 'max'=>50),
			array('property_desc', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('property_type_id, property_type_name, property_desc, create_dt, create_by, update_dt, update_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('property_type_name',$this->property_type_name,true);
