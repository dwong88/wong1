...
class Roomtype extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('room_type_name', 'length', 'max'=>30),
			array('room_type_desc', 'length', 'max'=>100),
			array('room_type_cleaning_minutes', 'length', 'max'=>6),
			array('room_type_availability_threshold', 'length', 'max'=>6),
			...
			array('room_type_rack_rate', 'length', 'max'=>15.2),
			array('room_type_default_extra_child_rate', 'length', 'max'=>15.2),
			array('room_type_default_extra_adult_rate', 'length', 'max'=>15.2),
			array('room_type_default_infant_rate', 'length', 'max'=>15.2),
			array('room_type_included_occupants', 'length', 'max'=>6),
			array('room_type_maximum_occupants', 'length', 'max'=>6),
			array('room_type_adult_required', 'length', 'max'=>4),
	...
	public function attributeLabels()
	{
		return array(
			...
			'update_by' => 'Update By',
			'room_type_cleaning_minutes' => 'Room Type Cleaning Minutes',
			'room_type_availability_threshold' => 'Room Type Availability Threshold',
			'room_type_minimum_availability_threshold' => 'Room Type Minimum Availability Threshold',
			'room_type_default_minimum_stay' => 'Room Type Default Minimum Stay',
			'room_type_default_maximum_stay' => 'Room Type Default Maximum Stay',
			'room_type_rack_rate' => 'Room Type Rack Rate',
			'room_type_default_extra_child_rate' => 'Room Type Default Extra Child Rate',
			'room_type_default_extra_adult_rate' => 'Room Type Default Extra Adult Rate',
			'room_type_default_infant_rate' => 'Room Type Default Infant Rate',
			'room_type_included_occupants' => 'Room Type Included Occupants',
			'room_type_maximum_occupants' => 'Room Type Maximum Occupants',
			'room_type_adult_required' => 'Room Type Adult Required',
			'room_type_room_size' => 'Room Type Room Size',
			'room_type_bed_size' => 'Room Type Bed Size',
			'room_type_guest_capacity' => 'Room Type Guest Capacity',
			'room_type_total_room' => 'Room Type Total Room',
		);
	}
